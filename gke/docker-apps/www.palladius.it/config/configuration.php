...
class JConfig
{
	...
	public $sitename = 'Joomla su Masagno (Specklato)!';            // Name of Joomla site
	...
	public $host = '104.197.195.148';         // This is normally set to localhost
	public $user = 'jumla3user';              // DB username
	public $password = 'DibbiVerginelloXOra'; // DB password
	public $db = 'palladiusit_jumla3';        // DB database name
	public $dbprefix = 'ty97s_';              // Do not change unless you need to!

	/* Server Settings */
	public $secret = 'FBVtgWIk5lAzEUxH';     // Change this to something more secure
	public $gzip = '0';
